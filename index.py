...
async def handle_theme_css(_request: web.Request) -> web.FileResponse:
    return web.FileResponse(Path("static/theme.css"))


async def handle_theme_js(_request: web.Request) -> web.FileResponse:
    return web.FileResponse(Path("static/theme.js"))


async def handle_manual(_request: web.Request) -> web.FileResponse:
    return web.FileResponse(Path("static/USER_MANUAL.html"))
...
async def main():
    ...
    try:
        ...
        app.router.add_get("/theme.css", handle_theme_css)
        app.router.add_get("/theme.js", handle_theme_js)
